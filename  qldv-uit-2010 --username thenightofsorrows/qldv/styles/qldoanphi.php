...
{	
	...
	$thongtin.="<tr class=\"user_manage_form_table_content_highlight\" onClick=\"javascript:getcontent($i);\">
						...
						<td width=\"87px\"><input class =\"user_manage_form_textbox\" name=\"sotien[$id_dv]\"></td>
						<td width=\"83px\"><input class=\"user_manage_form_textbox\" name=\"ngaydong[$id_dv]\" id=\"ngaydong$id_dv\"></td>
						<script>$(\"#ngaydong$id_dv\").datepick();</script>
					</tr>";
